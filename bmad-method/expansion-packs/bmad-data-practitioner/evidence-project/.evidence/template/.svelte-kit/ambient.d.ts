...
declare module '$env/static/private' {
	...
	export const DATA_STACK_ENV: string;
	...
	export const DBT_PROJECT_DIR: string;
	export const npm_execpath: string;
	export const VIRTUAL_ENV: string;
	export const PATH: string;
	export const DATA_STACK_HOME: string;
	...
	export const DBT_PROFILES_DIR: string;
	...
	export const JEST_WORKER_ID: string;
	...
	export const npm_package_bin_bmad: string;

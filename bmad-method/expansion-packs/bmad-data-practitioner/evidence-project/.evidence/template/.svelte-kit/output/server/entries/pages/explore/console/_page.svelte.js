import { c as create_ssr_component, o as onDestroy, v as validate_component, f as add_attribute, e as escape, n as null_to_empty, d as each, b as subscribe, s as setContext, p as add_styles, q as merge_ssr_styles, r as globals } from "../../../../chunks/index3.js";
...
import { I as Icon, a as ChevronUp, b as ChevronDown, S as Search, d as ChevronsLeft, e as ChevronLeft, C as ChevronRight, f as ChevronsRight } from "../../../../chunks/Icon.js";
...
const DownloadData = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${display ? `<div><button type="${"button"}"${add_attribute("aria-label", text, 0)} class="${escape(null_to_empty($$props.class), true) + " svelte-p80uux"}"><span>${escape(text)}</span>
...
const ErrorChart = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div width="${"100%"}" class="${"grid grid-rows-auto box-content grid-cols-1 justify-center bg-red-50 text-grey-700 font-ui font-normal rounded border border-red-200 min-h-[150px] py-5 px-8 my-5 print:break-inside-avoid"}"><div class="${"m-auto w-full"}"><div class="${"font-bold text-center text-lg"}">${escape(chartType)}</div>
    ...
    chartType.includes("Value") ? "w-[7.8em]" : ""
			...
			${`${error === ProdMissingCredentialsError ? `<br><a class="${"credentials-link svelte-1no0yro"}" href="${"https://docs.evidence.dev/cli/#environment-variables"}">View environment variables →</a>` : ``}`}</div></div>
</div>`;
});
const css$1 = {
  code: ".search-container.svelte-cnwsl9{width:30%;display:block;align-items:center;border:1px solid var(--grey-300);border-radius:4px;height:22px;position:relative;margin:25px 3px 10px 3px;box-sizing:content-box}.search-icon.svelte-cnwsl9{height:16px;width:16px;padding-left:3px;margin:0;position:absolute;top:50%;transform:translateY(-50%);-ms-transform:translateY(-50%);color:var(--grey-400);box-sizing:content-box}.search-bar.svelte-cnwsl9{margin:0;position:absolute;top:50%;transform:translateY(-50%);-ms-transform:translateY(-50%);border:none;padding-left:23px;color:var(--grey-600);font-size:9pt;width:calc(100% - 30px);font-family:Arial;line-height:normal}input.search-bar.svelte-cnwsl9::-moz-placeholder{color:var(--grey-700)}input.search-bar.svelte-cnwsl9::placeholder{color:var(--grey-700)}.svelte-cnwsl9:focus{outline:none}@media(max-width: 600px){.search-container.svelte-cnwsl9{width:98%;height:28px}.search-bar.svelte-cnwsl9{font-size:16px;width:calc(100% - 40px)}}@media print{.search-container.svelte-cnwsl9{visibility:hidden}}",
  map: null
};
const SearchBar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"search-container svelte-cnwsl9"}"><input class="${"search-bar svelte-cnwsl9"}" type="${"text"}"${add_attribute("placeholder", placeholder, 0)}${add_attribute("value", value, 0)}>
	<div class="${"search-icon svelte-cnwsl9"}">${validate_component(Icon, "Icon").$$render($$result, { src: Search, class: "pl-0.5" }, {}, {})}</div>
</div>`;
});
...
const css = {
  code: ".table-container.svelte-kd019o.svelte-kd019o{font-size:9.5pt;width:97%}.container.svelte-kd019o.svelte-kd019o{width:100%;overflow-x:auto;scrollbar-width:thin;scrollbar-color:var(--scrollbar-color) var(--scrollbar-track-color);background-color:white}:root{--scrollbar-track-color:transparent;--scrollbar-color:rgba(0, 0, 0, 0.2);--scrollbar-active-color:rgba(0, 0, 0, 0.4);--scrollbar-size:0.75rem;--scrollbar-minlength:1.5rem}.container.svelte-kd019o.svelte-kd019o::-webkit-scrollbar{height:var(--scrollbar-size);width:var(--scrollbar-size)}.container.svelte-kd019o.svelte-kd019o::-webkit-scrollbar-track{background-color:var(--scrollbar-track-color)}.container.svelte-kd019o.svelte-kd019o::-webkit-scrollbar-thumb{background-color:var(--scrollbar-color);border-radius:7px;background-clip:padding-box}.container.svelte-kd019o.svelte-kd019o::-webkit-scrollbar-thumb:hover{background-color:var(--scrollbar-active-color)}.container.svelte-kd019o.svelte-kd019o::-webkit-scrollbar-thumb:vertical{min-height:var(--scrollbar-minlength);border:3px solid transparent}.container.svelte-kd019o.svelte-kd019o::-webkit-scrollbar-thumb:horizontal{min-width:var(--scrollbar-minlength);border:3px solid transparent}table.svelte-kd019o.svelte-kd019o{display:table;width:100%;border-collapse:collapse;font-variant-numeric:tabular-nums}th.svelte-kd019o.svelte-kd019o,td.svelte-kd019o.svelte-kd019o{padding:2px 8px;white-space:nowrap;overflow:hidden}th.svelte-kd019o.svelte-kd019o{border-bottom:1px solid var(--grey-600)}.row-lines.svelte-kd019o.svelte-kd019o{border-bottom:thin solid var(--grey-200)}.shaded-row.svelte-kd019o.svelte-kd019o{background-color:var(--grey-100)}.string.svelte-kd019o.svelte-kd019o{text-align:left}.date.svelte-kd019o.svelte-kd019o{text-align:left}.number.svelte-kd019o.svelte-kd019o{text-align:right}.boolean.svelte-kd019o.svelte-kd019o{text-align:left}.sort-icon.svelte-kd019o.svelte-kd019o{width:12px;height:12px;vertical-align:middle}.icon-container.svelte-kd019o.svelte-kd019o{display:inline-flex;align-items:center}.page-changer.svelte-kd019o.svelte-kd019o{padding:0;color:var(--grey-400);height:1.1em;width:1.1em}.index.svelte-kd019o.svelte-kd019o{color:var(--grey-300);text-align:left;max-width:-moz-min-content;max-width:min-content}.pagination.svelte-kd019o.svelte-kd019o{font-size:12px;display:flex;align-items:center;justify-content:space-between;height:2em;font-family:var(--ui-font-family);color:var(--grey-500);-webkit-user-select:none;-moz-user-select:none;user-select:none;text-align:right;margin-top:0.5em;margin-bottom:1.8em;font-variant-numeric:tabular-nums}.page-labels.svelte-kd019o.svelte-kd019o{display:flex;justify-content:flex-start;align-items:center;gap:3px}.selected.svelte-kd019o.svelte-kd019o{background:var(--grey-200);border-radius:4px}.page-changer.svelte-kd019o.svelte-kd019o{font-size:20px;background:none;border:none;cursor:pointer;transition:color 200ms}.page-changer.hovering.svelte-kd019o.svelte-kd019o{color:var(--blue-600);transition:color 200ms}.page-changer.svelte-kd019o.svelte-kd019o:disabled{cursor:auto;color:var(--grey-300);-webkit-user-select:none;-moz-user-select:none;user-select:none;transition:color 200ms}.page-icon.svelte-kd019o.svelte-kd019o{height:1em;width:1em}.page-input.svelte-kd019o.svelte-kd019o{width:23px;text-align:center;padding:0;margin:0;border:1px solid transparent;border-radius:4px;font-size:12px;color:var(--grey-500)}.table-footer.svelte-kd019o.svelte-kd019o{display:flex;justify-content:flex-end;align-items:center;margin:10px 0px;font-size:12px;height:9px}.page-input.svelte-kd019o.svelte-kd019o::-webkit-outer-spin-button,.page-input.svelte-kd019o.svelte-kd019o::-webkit-inner-spin-button{-webkit-appearance:none;margin:0}.page-input[type='number'].svelte-kd019o.svelte-kd019o{-moz-appearance:textfield;-webkit-appearance:textfield;appearance:textfield}.page-input.hovering.svelte-kd019o.svelte-kd019o{border:1px solid var(--grey-200)}.page-input.error.svelte-kd019o.svelte-kd019o{border:1px solid var(--red-600)}.page-input.svelte-kd019o.svelte-kd019o::-moz-placeholder{color:var(--grey-500)}.page-input.svelte-kd019o.svelte-kd019o::placeholder{color:var(--grey-500)}button.svelte-kd019o:enabled>.page-icon.svelte-kd019o:hover{color:var(--blue-800)}.svelte-kd019o.svelte-kd019o:focus{outline:none}.svelte-kd019o.svelte-kd019o::-moz-placeholder{color:var(--grey-400);opacity:1}.svelte-kd019o.svelte-kd019o::placeholder{color:var(--grey-400);opacity:1}.svelte-kd019o.svelte-kd019o:-ms-input-placeholder{color:var(--grey-400)}.svelte-kd019o.svelte-kd019o::-ms-input-placeholder{color:var(--grey-400)}th.type-indicator.svelte-kd019o.svelte-kd019o{color:var(--grey-400);font-weight:normal;font-style:italic}.row-link.svelte-kd019o.svelte-kd019o{cursor:pointer}.row-link.svelte-kd019o.svelte-kd019o:hover{--tw-bg-opacity:1;background-color:rgb(239 246 255 / var(--tw-bg-opacity))}.noresults.svelte-kd019o.svelte-kd019o{display:none;color:var(--grey-400);text-align:center;margin-top:5px}.shownoresults.svelte-kd019o.svelte-kd019o{display:block}.print-page-count.svelte-kd019o.svelte-kd019o{display:none}@media(max-width: 600px){.page-changer.svelte-kd019o.svelte-kd019o{height:1.2em;width:1.2em}.page-icon.svelte-kd019o.svelte-kd019o{height:1.2em;width:1.2em}.page-count.svelte-kd019o.svelte-kd019o{font-size:1.1em}.page-input.svelte-kd019o.svelte-kd019o{font-size:1.1em}}@media print{.avoidbreaks.svelte-kd019o.svelte-kd019o{-moz-column-break-inside:avoid;break-inside:avoid}.pagination.svelte-kd019o.svelte-kd019o{-moz-column-break-inside:avoid;break-inside:avoid}.page-changer.svelte-kd019o.svelte-kd019o{display:none}.page-count.svelte-kd019o.svelte-kd019o{display:none}.print-page-count.svelte-kd019o.svelte-kd019o{display:inline}}",
  map: null
};
let marginTop = "1.5em";
...
const DataTable = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
	...
	<div class="${"table-container svelte-kd019o"}"${add_styles({
      ...
      {}
		...
		<div class="${"container svelte-kd019o"}"><table class="${"svelte-kd019o"}"><thead class="${"svelte-kd019o"}"><tr class="${"svelte-kd019o"}">${rowNumbers ? `<th class="${"index w-[2%] svelte-kd019o"}"${add_styles({ "background-color": headerColor })}></th>` : ``}
						${$props.columns.length > 0 ? `${each($props.columns, (column) => {
      return `<th class="${escape(null_to_empty(safeExtractColumn(column).type), true) + " svelte-kd019o"}"${add_styles({
      ...
      return `<th class="${escape(null_to_empty(column.type), true) + " svelte-kd019o"}"${add_styles({
        "color": headerFontColor,
        "background-color": headerColor,
        "cursor": sortable ? "pointer" : "auto"
      })}><span class="${"col-header svelte-kd019o"}">${escape(formatColumnTitles ? column.title : column.id)}</span>
									${sortBy.col === column.id ? `${validate_component(SortIcon, "SortIcon").$$render($$result, { ascending: sortBy.ascending }, {}, {})}` : ``}
								</th>`;
    })}`}</tr></thead>
      ...
      return `<tr class="${[
      ...
      ].join(" ").trim()}">${rowNumbers ? `<td class="${["index w-[2%] svelte-kd019o", rowLines ? "row-lines" : ""].join(" ").trim()}">${i === 0 ? `${escape((index + i + 1).toLocaleString())}` : `${escape((index + i + 1).toLocaleString())}`}
							</td>` : ``}
        ...
        return `
								...
								<td class="${[
          escape(null_to_empty(safeExtractColumn(column).type), true) + " svelte-kd019o",
          rowLines ? "row-lines" : ""
          ...
          0
        )} class="${"mx-auto my-2 max-w-[unset] rounded-[unset] svelte-kd019o"}"${add_styles({
          "height": column.height,
          "width": column.width
        })}>` : `${column.contentType === "link" && row[column.id] !== void 0 ? `
										${column.linkLabel != void 0 && row[column.linkLabel] == void 0 && column.linkLabel in row ? `-` : `<a${add_attribute("href", row[column.id], 0)}${add_attribute("target", column.openInNewTab ? "_blank" : "", 0)} class="${"text-blue-600 hover:text-blue-700 transition-colors duration-200 svelte-kd019o"}">${column.linkLabel != void 0 ? `
          ...
          return `
            ...
            columnSummary2.columnUnitSummary
											...
											</a>`}` : `${column.contentType === "delta" && row[column.id] !== void 0 ? `<div class="${"m-0 text-xs font-medium font-ui svelte-kd019o"}" style="${"color: " + escape(
          row[column.id] >= 0 && !column.downIsGood || row[column.id] < 0 && column.downIsGood ? "var(--green-700)" : "var(--red-700)",
          true
        )}"><div class="${"svelte-kd019o"}"${add_styles({ "text-align": column.align ?? "right" })}>${column.showValue ? `<span class="${"svelte-kd019o"}">${escape(formatValue(
          row[column.id],
          ...
          safeExtractColumn(column).columnUnitSummary
													...
													${column.deltaSymbol ? `<span class="${"font-[system-ui] svelte-kd019o"}"><!-- HTML_TAG_START -->${row[column.id] >= 0 ? "&#9650;" : "&#9660;"}<!-- HTML_TAG_END --></span>` : ``}` : ``}</div>
        ...
        return `<td class="${[
          escape(null_to_empty(column.type), true) + " svelte-kd019o",
          rowLines ? "row-lines" : ""
		...
		${paginated && pageCount > 1 ? `<div class="${"pagination svelte-kd019o"}"><div class="${"page-labels svelte-kd019o"}"><button aria-label="${"first-page"}" class="${["page-changer svelte-kd019o", ""].join(" ").trim()}" ${currentPage === 1 ? "disabled" : ""}><div class="${"page-icon flex items-center svelte-kd019o"}">${validate_component(Icon, "Icon").$$render($$result, { src: ChevronsLeft }, {}, {})}</div></button>
					<button aria-label="${"previous-page"}" class="${["page-changer svelte-kd019o", ""].join(" ").trim()}" ${currentPage === 1 ? "disabled" : ""}><div class="${"page-icon h-[0.83em] flex items-center svelte-kd019o"}">${validate_component(Icon, "Icon").$$render($$result, { src: ChevronLeft, class: "h-[0.83em]" }, {}, {})}</div></button>
					<span class="${"page-count svelte-kd019o"}">Page <input class="${[
      "page-input svelte-kd019o",
      " " + (inputPage > pageCount ? "error" : "")
    ].join(" ").trim()}" type="${"number"}"${add_attribute("placeholder", currentPage, 0)}${add_attribute("value", inputPage, 0)}>
						/
						<span class="${"page-count ml-1 svelte-kd019o"}">${escape(pageCount.toLocaleString())}</span></span>
					<span class="${"print-page-count svelte-kd019o"}">${escape(displayedPageLength.toLocaleString())} of ${escape(totalRows.toLocaleString())} records</span>
					<button aria-label="${"next-page"}" class="${["page-changer svelte-kd019o", ""].join(" ").trim()}" ${currentPage === pageCount ? "disabled" : ""}><div class="${"page-icon h-[0.83em] flex items-center svelte-kd019o"}">${validate_component(Icon, "Icon").$$render($$result, { src: ChevronRight, class: "h-[0.83em]" }, {}, {})}</div></button>
					<button aria-label="${"last-page"}" class="${["page-changer svelte-kd019o", ""].join(" ").trim()}" ${currentPage === pageCount ? "disabled" : ""}><div class="${"page-icon flex items-center svelte-kd019o"}">${validate_component(Icon, "Icon").$$render($$result, { src: ChevronsRight }, {}, {})}</div></button></div>
      ...
      {},
      {}
    )}` : ``}</div>` : `<div class="${"table-footer svelte-kd019o"}">${downloadable ? `${validate_component(DownloadData, "DownloadData").$$render(
      $$result,
      {
        class: "download-button",
        data: tableData,
      ...
      {}
		...
		<div class="${["noresults svelte-kd019o", showNoResults ? "shownoresults" : ""].join(" ").trim()}">No Results</div></div>` : `${validate_component(ErrorChart, "ErrorChart").$$render($$result, { error, chartType: "Data Table" }, {}, {})}`}`;
  } while (!$$settled);
  $$unsubscribe_props();
  return $$rendered;
});

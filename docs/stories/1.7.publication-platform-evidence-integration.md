...
- [ ] Task 1: Install and configure Evidence.dev environment (AC: 1)
  - [ ] Add Evidence.dev ^25.0.0 to project dependencies
  - [ ] Create Evidence.dev project structure within expansion pack
  - [ ] Configure Evidence.dev with DuckDB WASM integration
  - [ ] Set up Universal SQL connection to analytical datasets
  - [ ] Implement Evidence.dev build integration with existing web-builder
  - [ ] Test Evidence.dev installation and basic site generation

- [ ] Task 2: Create PublicationEngine component (AC: 1, 4)
  - [ ] Create `tools/data-services/publication-engine.js`
  - [ ] Implement Evidence.dev static site generation with Universal SQL integration
  - [ ] Add automated narrative generation using LLM capabilities
  - [ ] Create publication workflow coordination and management
  - [ ] Implement multi-format export (PDF, HTML, static) capabilities
  - [ ] Add integration with existing BMad web-builder patterns

- [ ] Task 3: Configure Universal SQL with DuckDB integration (AC: 3)
  - [ ] Set up DuckDB WASM for client-side analytical processing
  - [ ] Configure Evidence.dev Universal SQL connection to DuckDB datasets
  - [ ] Implement real-time data handling with scheduled refreshes
  - [ ] Add build-time data extraction for static site optimization
  - [ ] Create SQL query optimization for Evidence.dev performance
  - [ ] Test Universal SQL integration with transformed datasets from Story 1.4
...
- [ ] Task 6: Enable static site generation and deployment (AC: 5)
  ...
  - [ ] Add Evidence Cloud and self-hosting deployment options
  - [ ] Create public/private deployment configurations with access controls
  - [ ] Implement embedded reporting capabilities for multi-tenant architecture
...
- Consume dbt transformation outputs for publication data sources
- Integrate with dbt documentation for lineage and metadata
...
- Complete publication pipeline (DuckDB → dbt → Analysis → Evidence.dev)
